OOJSPlus.ui.data.StateManager = function ( cfg ) { // eslint-disable-line no-unused-vars
...
OOJSPlus.ui.data.StateManager.prototype.load = function ( id ) {
	...
	if ( state ) {
		try {
			...
			console.error( 'Failed to parse state for id:', id, e ); // eslint-disable-line no-console
		}
	}
	return {};
};
